...
export const BizResearchReportListCard = memo(({ items }: BizResearchReportListCardProps) => {
  ...
  if (!items) {
    return (
      <div className="h-full flex flex-col rounded-lg border p-3">
        <div className="text-sm font-bold mb-2">行业报告</div>
  ...
  return (
    <div className="h-full flex flex-col rounded-lg border p-3 overflow-auto">
      <div className="flex gap-2 items-center mb-3">
        <div className="text-sm font-bold">行业报告</div>
        <button
